...
from con_models.data.utils import TextEncoder
import con_models.data.config as cfg
import con_models.data.data as data
import con_models.models.models as models
import con_models.train.batch as batch_utils

from con_models.evaluate.sampler import BeamSampler, GreedySampler, TopKSampler

import con_models.utils.utils as utils
...
def load_data(dataset, opt):
    ...
    encoder_path = "../con_models/model/encoder_bpe_40000.json"
    bpe_path = "../con_models/model/vocab_40000.bpe"
...
def load_conceptnet_data(opt):
    ...
    if opt.data.get("maxr", None) is None:
        if opt.data.rel == "language":
            ...
            opt.data.maxr = 1
    path = "../con_models/conceptnet/processed/generation/{}.pickle".format(
    utils.make_name_string(opt.data))
